...
#us_states_cleaned <- rmapshaper::ms_filter_islands(us_states_sf, min_area = 5e9)
...
# 
# bbox <- st_bbox(c(
#   xmin = -180, xmax = -60,  # longitude range: includes shifted AK/HI
#   ymin = 20, ymax = 55      # latitude range: enough for whole US
# ), crs = st_crs(map_data_shifted))
# 
# # Crop the spatial data
# map_data_clipped <- st_crop(map_data_shifted, bbox)
# 
# 
# 
# 
...
# 
# # 
# # bbox <- st_sfc(st_polygon(list(cbind(
# #   c(-125, -66, -66, -125, -125),  # Longitude
# #   c(24, 24, 50, 50, 24)           # Latitude
# # ))), crs = 4326)
# 
# # Perform the intersection to crop the data
# # map_data_mainland <- st_intersection(us_states_sf, bbox)
# 
# # Check the result
# # print(map_data_mainland)
# 
# 
# 
# bbox <- st_transform(bbox, crs = st_crs(us_states_sf))
# 
# # Now you can safely run spatial operations
# map_data_mainland <- st_intersection(us_states_sf, bbox)
...
# 
# # map_data_shifted <- st_crop(map_data_shifted, xmin = -180, xmax = -180, ymin = -180, ymax = 180)
# 
# 
# 
# 
