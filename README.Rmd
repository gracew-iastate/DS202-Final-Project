...
# 
# healthwfips$CityFIPS <- as.numeric(healthwfips$CityFIPS)
# 
# 
# top_cities <- top_cities %>%
#   mutate(CityFIPS = ifelse(CityFIPS == 1571550, 15003, CityFIPS))
...
# write_xlsx(state_means, 'C:\\Users\\songb\\Desktop\\statemeans.xlsx')
