...
THE DATA CAN BE RETRIEVED FROM THE BOX FOLDER
IT TAKES A LOT OF COMPUTATIONAL POWER TO RUN THE FOLLOWING CODE CHUNK
THANK YOU : )
...
Perform lm analysis to determine correlation between variables
```{r}
